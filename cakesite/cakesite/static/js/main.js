window.addEventListener("load", event => {
    ...
    function productHeading() {
        ...
        // Close Shopphing cart
        $(document).on("click",".shoppingIcon",function(e){ if (itemNumber.innerText != "0")
            e.preventDefault(),
            $(".cart_overlay").fadeIn()
            }),
        $(document).on("click",".cart_overlay",function(e){
            $(".shoppingMenu").removeClass("openShopping"),
            $(this).fadeOut(function(){
                $(".shoppingMenu .openShopping").removeClass("openShopping");
            }
            )})
